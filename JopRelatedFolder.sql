...
SELECT DISTINCT Year, Monthname
FROM Date
WHERE Year BETWEEN 2013 AND 2015 AND MonthName LIKE 'J%' OR '%a%';

SELECT DISTINCT Year, MonthName
FROM Date
WHERE Year BETWEEN 2013 AND 2015 AND MonthName LIKE 'J%' AND MonthName LIKE '%a%';

SELECT Year, Monthname
FROM Date
WHERE Year BETWEEN 2013 AND 2015 AND Month LIKE 'J%' OR Month LIKE '%a%';
